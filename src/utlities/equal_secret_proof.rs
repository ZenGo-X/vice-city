...
impl EqProof {
    pub fn prove(statement: &Statement, witness: &Witness) -> Result<Self, ProofError> {
...
mod tests {
    ...
    use crate::utlities::equal_secret_proof::Statement;
    use crate::utlities::equal_secret_proof::Witness;
